...
# SPECIAL VERSION OF SCRIPT FOR COMPETITION
# Created 2020-10-24 to kick ass and take names
...
if [ "$__debug" == true ];
  then
    ...
    # start the miner!
    script -c "cargo testnet start --config ./testnet/stacks-node/conf/krypton-miner-conf.toml" $HOME/$__file
fi
